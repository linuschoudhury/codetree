...
k=[0]*(N+1)
for i in range(T):
    if handshakes[i][1] in infected and handshakes[i][2] in infected:
        k[handshakes[i][1]]+=1
        k[handshakes[i][2]]+=1
    elif handshakes[i][1] in infected and k[handshakes[i][1]]<K:
        infected.append(handshakes[i][2])
        k[handshakes[i][1]]+=1
        #print(k[handshakes[i][1]])
        #print(handshakes[i][1])
    elif handshakes[i][2] in infected and k[handshakes[i][2]]<K:
        infected.append(handshakes[i][1])
        k[handshakes[i][2]]+=1
        #print(k[handshakes[i][2]])
